...
pathdf = "/media/miguel/Granja azul/TFG/Codigo/Datos/InfTraining/merged_dfTraining_serialized.pickle"
pathRadiografias = "/media/miguel/Granja azul/TFG/Radiografias/Radiografias Training/Prinicipal/manifest-1617905855234/"
pathNumpys = "/media/miguel/Granja azul/TFG/Numpys/ImagenesTrainingCompletas"
...
for index, row in tqdm(merged_df.iterrows(), total=merged_df.shape[0], desc="Cargando imagen"):
    ...
    #if row["Actionable"] == 1 or row["Benign"] == 1 or row["Cancer"] == 1:
